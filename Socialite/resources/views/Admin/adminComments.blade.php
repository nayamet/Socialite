...
<div class="row vh-100">
            ...
            <ul class="list-unstyled ps-0 ms-4">
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded collapsed text-black " data-bs-toggle="collapse" data-bs-target="#orders-collapse" aria-expanded="false">
                        <a href="{{route('admin.posts')}}"><i class="fas fa-boxes"></i> Posts&nbsp;</a>
                ...
                <li class="mb-1">
                    <button class="btn align-items-center rounded text-black">
                        <a href="{{route('admin.comments')}}"><i class="fas fa-search"></i> Comments&nbsp;</a>
        ...
        <div class="col" style="margin-right:-15px;">  
            ...
            <div class="row container">
                <div>
                    <h3 class="p-2 border-primary border-bottom border-primary pb-4">Posts</h3>
                    <div class="card">
                                ...
                                <tbody>
                                    @foreach($comments as $c)
                                        <tr>
                                            <td>{{$c->user->name}}</td>
                                            <td>{{$c->user->email}}</td>
                                            <td>{{$c->post->postText}}</td>
                                            <td>{{$c->text}}</td>
                                            <td>{{$c->createdAt}}</td>
                                            <td><a href="{{route('comment.delete', ['commentId' => encrypt($c->id)])}}"><button class="btn btn-danger">Delete comment</button></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                              </table>
